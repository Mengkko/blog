...
date: 2019-08-09 09:48:00
category: node
tags: Node, nodejs, js, lib, 라이브러리, library, 유용한, 정리, list, 자료
---

Node js로 개발을 할때 너무 많은 패키지들이 필요하고 이를 기억하기 힘들어서 구글 검색을 통해

패키지들을 잘 모아놓은 블로그를 발견해 퍼왔다. 감사합니다. [KH BYUN](https://novemberde.github.io/)님

출처 : [https://novemberde.github.io/node/2017/11/05/Node.JS_Library.html](https://novemberde.github.io/node/2017/11/05/Node.JS_Library.html)
